...
import { setSidebarOpenCookie } from '@/actions/set-sidebar';
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn('group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full bg-background', className)}
          {...props}
        >
          {children}
        </div>
